          ...
          <div className={s.forgotEmail}>
            {passwordStatus === "succeeded" && (
              <div>
                ...
                <img className={s.photo} src={openMail} alt="UserPhoto" />
                <div className={s.helpEmailText1}>
                  We've sent Email with instruction to {email}
                </div>
                <SuperButton onClick={backToLogin} className={s.forgotButton}>
                  Back to login
                </SuperButton>
              </div>
            )}
