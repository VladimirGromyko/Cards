...
import { instance } from "m1-main/dal/instance";
...
export const packsAPI = {
  setPacks(param: PacksGetRequestType) {
    ...
    return instance.get<
      ...
      // PacksGetRequestType,
      AxiosResponse<PacksGetResponseDataType>
    >(`cards/pack`, param);
  },
  ...
  postPacks(pack: PacksPostRequestType) {
    return instance.post<
      ...
      AxiosResponse<PacksPostResponseType>
    >("cards/pack", pack);
  },
  deletePacks(param: PacksDeleteRequestType) {
    return instance.delete<
      PacksDeleteRequestType,
      AxiosResponse<PacksDeleteResponseType>
    >("cards/pack", param);
  },
  putPacks(param: PacksPutRequestType) {
    return instance.put<
      PacksPutRequestType,
      AxiosResponse<PacksPutResponseType>
    >("cards/pack", param);
  },
};
